<?php
	...
	class DB_CONFIG
	{
		...
		private const USERNAME = 'komiljonov_db36';
		private const PASSWORD = 'st6BWHM33WjiGfqd';
		private const DATABASE_NAME = 'komiljonov_db36';
		...
		{
			return $this->dataSet = mysqli_query($this->conn, $this->escapeString($query));
		}

		// Ma'lumotlar bazasiga qo'lda so'rov yuborish
		public function withSqlQueryWithOutEscapeString($query)
		{
			return $this->dataSet = mysqli_query($this->conn, $query);
		}
